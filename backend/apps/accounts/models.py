...
class Portfolio(models.Model):
    """The Super Admin's private AI resume workspace.

    One workspace per Super Admin. The admin uploads their own resume; the AI
    reviews it (pros/cons/improvements - private, only the admin sees it) and
    can rewrite it into a polished "rebuilt" version - delivered as an
    editable preview plus downloadable .docx/.pdf/.tex - with a fresh review
    of the rebuilt version. Nothing here is public: the resume and both
    reviews are never shown to faculty or students.
    """
